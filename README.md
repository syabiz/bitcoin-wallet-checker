...
| --- | --- | --- |
| `bitcoin-batch-checker-id.html` | 🇮🇩 Indonesian | Batch checker v2 — verify 100+ hashes with wordlist (Indonesian UI) |
...
> **Note:** Both HTML files include a Single Check tab (one hash + one password) and a Batch Check tab (multiple hashes + wordlist) in the same file.
...
* `bitcoin-batch-checker-id.html` — Indonesian
...
*Created for educational purposes. Please use responsibly.*
